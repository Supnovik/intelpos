<div class="page_of_users container">
    ...
    <div class="our_users">
        ...
        <div class="our_users-list">
            ...
            <a href='/users/Rules of the Russian language' class="our_users-block russian_language">Rules of the Russian
                language</a>
            <a href='/users/Rules of the English language' class="our_users-block english_language">Rules of the English
                language</a>
        </div>
